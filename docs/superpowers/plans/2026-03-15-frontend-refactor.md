...
- [x] **Step 2: Create Query Provider**
- [x] **Step 3: Register Provider in Layout**
- [x] **Step 4: Commit**
...
- [x] **Step 1: Implement Service Layer**
- [x] **Step 2: Commit**
...
- [x] **Step 1: Create useQuery hooks**
- [x] **Step 2: Create useMutation hooks**
- [x] **Step 3: Commit**
...
- [x] **Step 1: Implement Academic Years Manager**
- [x] **Step 2: Implement other Managers**
- [x] **Step 3: Refactor Main Page**
- [x] **Step 4: Commit**
